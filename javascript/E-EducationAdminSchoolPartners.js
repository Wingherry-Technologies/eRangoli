...
document.querySelector(".sidebar-main-vendor ul>ul:nth-of-type(4)>li:nth-child(5)").classList.add("submenu-active-highlight");
...
document.querySelector("#account-menu .mobile-dropdown:nth-child(7) li:nth-child(5)").classList.add("submenu-active-page");
