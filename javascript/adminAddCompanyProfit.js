...
function recalc() {
  ...
  // Margin text (based on final price vs vendor)
...
document.querySelector(".sidebar-main-vendor ul > ul:nth-of-type(1) > li:nth-child(4)")
...
document.querySelector("#account-menu .mobile-dropdown:nth-child(2) li:nth-child(4)")
