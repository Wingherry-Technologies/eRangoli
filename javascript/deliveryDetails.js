...
document.addEventListener("DOMContentLoaded", () => {
  ...
  if (deliveryCard && getComputedStyle(deliveryCard).display === "none") {
...
document.querySelector(".proceed-btn")?.addEventListener("click", () => {
  ...
  if (width > 1024) {
    if (mainGrid) {
      mainGrid.classList.remove("center-layout");
      mainGrid.style.display = "grid";
      mainGrid.style.gridTemplateColumns = "1.2fr 1fr 1fr";
    }
