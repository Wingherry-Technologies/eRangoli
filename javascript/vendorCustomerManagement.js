...
document.querySelector("#sidebar-main-vendor ul>li:nth-child(6)").classList.add("sidebar-active");

document.querySelector("#account-menu li:nth-child(6) .dropdown-header").classList.add("dropdown-header-active");
