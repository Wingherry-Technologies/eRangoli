...
document.querySelector(".sidebar-main-vendor ul>ul:nth-of-type(3)>li:nth-child(6)").classList.add("submenu-active-highlight");
...
document.querySelector("#account-menu .mobile-dropdown:nth-child(6) li:nth-child(6)").classList.add("submenu-active-page");
