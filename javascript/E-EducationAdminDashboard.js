...
const revenueChart = new Chart(document.getElementById("EEAD-revenueChart"), {
  type: "line",
  data: {
...
const orderChart = new Chart(document.getElementById("EEAD-orderChart"), {
  type: "bar",
  data: {
...
function updateOrders(type) {
  ...
  const receivedEl = document.getElementById("EEAD-receivedTotal");
  const deliveredEl = document.getElementById("EEAD-deliveredTotal");
  const transitEl = document.getElementById("EEAD-transitTotal");
...
new Chart(document.getElementById("EEAD-revenueDonutChart"), {
  type: "doughnut",
  data: {
...
document.querySelector("#account-menu .mobile-dropdown:nth-child(7) li:nth-child(1)").classList.add("submenu-active-page");
